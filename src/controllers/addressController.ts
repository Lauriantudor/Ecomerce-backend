...
// ADD NEW ADDRESS
const createAddrees = async (req: Request, res: Response) => {
  const { title, fullName, phoneNumber, city, county, country, streetAddress } =
    req.body;
...
//GET ALL ADDRESSES
const adminGetAllAddresses = async (req: Request, res: Response) => {
  try {
    const addresses = await prisma.address.findMany({
      include: {
        user: {
...
const adminGetAddressesByUserId = async (req: Request, res: Response) => {
